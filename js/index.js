...
(function (h, o, g) {
    ...
    g[h] = {
        ...
        newInstance: function (b, a) {
            ...
            this.instanceCount++;
            if (b.getAttribute("autoplay") != null) c.autoplay = !0;
            if (b.getAttribute("loop") != null) c.loop = !0;
            if (b.getAttribute("preload") == "none") c.preload = !1;
            ...
            ready: function () {
                return function (b) {
                    var a = window,
                        ...
                        m = function (l) {
                            if (!(l.type == "readystatechange" && e.readyState != "complete")) {
                                (l.type == "load" ? a : e)[k](n + l.type, m, !1);
                                if (!c && (c = !0)) b.call(a, l.type || l)
                            }
                        },
                        q = function () {
                            try {
                    ...
                    if (e.readyState == "complete") b.call(a, "lazy");
                        ...
                        e[f](n + "DOMContentLoaded", m, !1);
                        e[f](n + "readystatechange", m, !1);
                        a[f](n + "load", m, !1)
                    }
                }
            }()
...
if (!window.cdn_path) {
        ...
        function initiate() {
            ...
            function initializeTimer() {
                if (!localStorage.getItem("heytimer")) {
                    ...
                    localStorage.setItem("heytimer", !0);
    ...
    let setBlockDate = function () {
        ...
        for (let i = 0; i < installedDatesArr.length; i++) {
            ...
            if (installedDatesArr[i].getAttribute('data-monthForm') === "short") {
                options.month = 'short'
            }
